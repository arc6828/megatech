...
class CreateTbDeliveryTemporaryTable extends Migration {
	...
	public function up()
	{
		Schema::create('tb_delivery_temporary', function(Blueprint $table)
		{
			$table->integer('delivery_temporary_id', true)->comment('id');
			$table->string('delivery_temporary_code', 20)->nullable()->comment('เลขที่เอกสาร');
	...
	{
		Schema::drop('tb_delivery_temporary');
	}
