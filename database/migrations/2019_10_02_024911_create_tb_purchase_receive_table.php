...
class CreateTbPurchaseReceiveTable extends Migration {
	...
	public function up()
	{
		Schema::create('tb_purchase_receive', function(Blueprint $table)
		{
			$table->integer('purchase_receive_id', true)->comment('id');
			$table->string('purchase_receive_code', 20)->nullable()->comment('เลขที่เอกสาร');
			...
			$table->integer('department_id')->nullable()->comment('รหัสแผนก');
	...
	{
		Schema::drop('tb_purchase_receive');
	}
