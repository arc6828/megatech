                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group form-row text-center pr-5">
                            ...
                            <small class="col-lg-3 text-left"> {{ $customerpayment->customer->customer_code }}
                                {{ $customerpayment->customer->company_name }} </small>
                        ...
                        <div class="form-group form-row text-center pr-5">
                            ...
                            <small class="col-lg-3 text-left"> {{ number_format($customerpayment->debt_total, 2) }}
                            </small>

                            <label class="col-lg-3"> ยอดรวมรับชำระ </label>
                            <small class="col-lg-3 text-left"> {{ number_format($customerpayment->payment_total, 2) }}
                            </small>
                        </div>
                        <div class="form-group form-row text-center pr-5">
                            <label class="col-lg-3"> อัพโหลดรูป </label>
                            <small class="col-lg-3 text-left"> <a
                                    href="{{ url('/storage/' . $customerpayment->payment_file) }}"
                                    target="_blank">{{ $customerpayment->payment_file }}<a> </small>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            {{ number_format($customer_payment_details->sum('total_debt'), 2) }}</th>
                                        <th class="text-center">
                                            {{ number_format($customer_payment_details->sum('total_payment'), 2) }}</th>
                                        <th class="text-center">
                                            {{ number_format($customer_payment_details->sum('total_remain'), 2) }}</th>
                                    </tr>
                                </tfoot>
                                ...
                                <tbody>
                                    @foreach ($bank_transactions as $item)
                                        <tr>
                                            ...
                                            <th>{{ $item->bank_account->code }} {{ $item->bank_account->name }}
                                                {{ $item->bank_account->branch }}</th>
                                            <th>{{ $item->amount }}</th>
