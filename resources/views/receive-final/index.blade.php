                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Code</th><th>Is Code</th><th>Status Id</th><th>User Id</th><th>Remark</th><th>Total</th><th>Revision</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($receivefinal as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->code }}</td><td>{{ $item->is_code }}</td><td>{{ $item->status_id }}</td><td>{{ $item->user_id }}</td><td>{{ $item->remark }}</td><td>{{ $item->total }}</td><td>{{ $item->revision }}</td>
                                        <td>
                            ...
                            <div class="pagination-wrapper"> {!! $receivefinal->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
