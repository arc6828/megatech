<div class="form-group {{ $errors->has('product_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="product_id" type="number" id="product_id" value="{{ isset($stock->product_id) ? $stock->product_id : ''}}" >
...
<div class="form-group {{ $errors->has('action') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="action" type="text" id="action" value="{{ isset($stock->action) ? $stock->action : ''}}" >
