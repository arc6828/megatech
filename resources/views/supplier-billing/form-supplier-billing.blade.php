  ...
  <div class="card-body">
    ...
    <div class="row">      
      ...
      <div class="form-group col-lg-3">
        ...
        <input type="number" name="max_credit"  id="max_credit" class="form-control form-control-sm  "  value="{{isset($supplier)? $supplier->max_credit : ''}}"  >
      </div>
      <div class="form-group col-lg-3">
  ...
  <div class="card-body">
    ...
    <div class="row">      
      ...
      <div class="form-group col-lg-3">
        ...
        <input name="billing_duration" id="billing_duration" class="form-control form-control-sm  "  value="{{isset($supplier)? $supplier->billing_duration : ''}}">
      </div>
      <div class="form-group col-lg-3">
