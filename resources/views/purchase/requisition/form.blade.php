<div class="card">
    <div class="card-body">
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="purchase_requisition_code" id="purchase_requisition_code"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="internal_reference_id" id="internal_reference_id"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <select name="purchase_status_id" id="purchase_status_id" class="d-none form-control form-control-sm"
                    required>
                    <option value="">None</option>
