            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/purchase/return-order') }}" accept-charset="UTF-8"
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($returnorder as $item)
                                        <tr>
                                            ...
                                            <td>{{ date_format(date_create(explode(' ', $item->created_at)[0]), 'd-m-Y') }}
                                            </td>
                                            ...
                                            <td>
                                                @switch($item->purchase_status_id)
                                                    @case("-1")
                                                        <span
                                                            class="badge badge-pill badge-secondary">{{ $item->purchase_status->purchase_status_name }}</span>
                                                    @break
                                                    @case("5")
                                                        <span
                                                            class="badge badge-pill badge-primary">{{ $item->purchase_status->purchase_status_name }}</span>
                                                    @break
                                                    @case("14")
                                                        <span
                                                            class="badge badge-pill badge-success">{{ $item->purchase_status->purchase_status_name }}</span>
                                                    @break
                                                    @default
                                                        <span
                            ...
                            <div class="text-center mt-4">
                                ...
                                <a href="{{ url('/purchase/return-order/create') }}" class="btn btn-success "
                                    title="Add New ReturnOrder">
                                    <i class="fa fa-plus" aria-hidden="true"></i> เพื่มใบส่งคืนสินค้า
                                </a>
                            </div>
