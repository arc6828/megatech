...
@section('title','เพิ่มรายการในใบเสนอซื้อ')
	...
	<div class="card-block">
		<div class="row">
			<div class="col-lg-6 align-self-center">
				<h4 class="card-title">Purchase Requisition code :
					@foreach($table_purchase_requisition as $row_purchase_requisition)
					{{ $row_purchase_requisition->purchase_requisition_code }}
					@endforeach
				</h4>
				<h6 class="card-subtitle">Fill infomation in the form</h6>
			</div>
			<div class="col-lg-6 align-self-center">
				<form class="" action="{{ url('/') }}/purchase/purchase_requisition/{{ $purchase_requisition_id }}/purchase_requisition_detail/create" method="GET">
			...
			<div class="table-responsive">
				<table class="table table-hover text-center">
					...
					<tbody>
						...
						<form action="{{ url('/') }}/purchase/purchase_requisition/{{$purchase_requisition_id}}/purchase_requisition_detail" method="POST">
						{{ csrf_field() }}
					    {{ method_field('POST') }}
