<div class="card mt-4" id="table">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover text-center table-sm" id="table-purchase_order-detail" style="width:100%">
            </table>
        </div>
        <script>
            ...
            function createRow(id, element, purchase_order_detail_id) {
                ...
                return [
                    ...
                    "<input type='hidden' class='purchase_order_detail_id_edit' name='purchase_order_detail_id_edit[]'  value='" +
                    ...
                    "" + select,
                    "<input type='number' class='input amount_edit' name='amount_edit[]'  value='" + element
                    .amount + "' min='" + min_amount + "' max='" + max_amount + "' title='[" + min_amount + "," +
                    max_amount + "]' style='min-width:60px;'>"

                    +
                    "<input class='d-none input roundnum normal_price_edit' name='normal_price_edit[]'  value='" +
                    parseFloat(element.normal_price).toFixed(2) + "' disabled>" +
                    "<input type='number' step='any' class='d-none input roundnum discount_percent_edit' name='discount_percent_edit[]' max=" +
                    (checked ? parseFloat(element.max_discount_percent) + 100 : element.max_discount_percent) +
                    "  value='" + (parseFloat(discount_percent_edit).toFixed(2)) + "'>",
                    "<input class='input roundnum discount_price_edit' name='discount_price_edit[]'  value='" +
                    parseFloat(discount_price).toFixed(2) + "'>",
                    "<input class='input  roundnum total_edit' name='total_edit[]'  value='" + (discount_price *
                        element.amount) + "' disabled>",
                    @if (isset($order->purchase_order_code))
                        "",
                    @else
