...
<form id="form-delete" style="display: none;" action="{{ url('/') }}/purchase/purchase_order/{{ $row->purchase_order_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('DELETE') }}
...
<form class="" action="{{ url('/') }}/purchase/purchase_order/{{ $row->purchase_order_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="card">
		<div class="card-block">
			...
			<div class="col-lg-9 align-self-center">
				<h4 class="card-title">Purchase Order code : {{ $row->purchase_order_code }}</h4>
	...
	@include('purchase/purchase_order_detail/table')
...
<div style="display:none;">
	...
	<script>
		function onDelete(id){
			...
			form.action = "{{ url('/') }}/purchase/purchase_order/{{ $purchase_order_id }}/purchase_order_detail/"+id;
			//SUBMIT
