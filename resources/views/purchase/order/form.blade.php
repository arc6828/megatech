    ...
    <div class="card-body">
      ...
      <a href="{{ url('/purchase/order') }}" title="Back" class="btn btn-warning btn-sm" >
            ...
            <div class="row my-4">
                ...
                <div class="col-lg-6">
                    <div class="text-center"><img
                            src="data:image/png;base64,{{ DNS1D::getBarcodePNG($row->purchase_order_code, 'C128') }}"
                            alt="barcode" /></div>
                    ...
                    @if (isset($order))
                        @if ($mode == 'show')
                            ...
                            <a class="btn btn-warning btn-sm btn-print mr-2"
                                href="{{ url('/') }}/purchase/order/{{ $row->purchase_order_id }}/edit"
                                title="แก้ไข">
                                <i class="fas fa-edit"></i> แก้ไข
                            </a>
                            <a class="btn btn-primary btn-sm btn-print mr-2"
                                href="{{ url('/') }}/purchase/order/{{ $row->purchase_order_id }}/pdf"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="purchase_order_code" id="purchase_order_code" class="form-control form-control-sm"
                    readonly>
            </div>
            ...
            <div class="col-lg-3 d-none">
                <input name="external_reference_doc" id="external_reference_doc"
                    class="form-control form-control-sm form-control-line" value="-" required>
            </div>
        </div>
            ...
            <div class="col-lg-3">
                ...
                @if (isset($order))
                    @switch($order->purchase_status_id)
                        @case(3)
                            <span
                                class="badge badge-pill badge-warning">{{ $order->purchase_status->purchase_status_name }}</span>
                        @break
                        @case(4)
                            <span
                                class="badge badge-pill badge-success">{{ $order->purchase_status->purchase_status_name }}</span>
                        @break
                        @case(-1)
                            <span
                                class="badge badge-pill badge-secondary">{{ $order->purchase_status->purchase_status_name }}</span>
                        @break
                    @endswitch
                @endif
            </div>
