<div class="card">
    <div class="card-body">
            ...
            <i class="fa fa-arrow-left" aria-hidden="true"></i> Back
                ...
                <div class="col-lg-4">
                    <div class="text-center"><img
                            src="data:image/png;base64,{{ DNS1D::getBarcodePNG($row->purchase_receive_code, 'C128') }}"
                            alt="barcode" /></div>
                ...
                <div class="col-lg-4  text-right">
                    ...
                    @if ($mode == 'show')
                        <a class="btn btn-warning btn-sm btn-print mr-2"
                            href="{{ url('/') }}/purchase/receive/{{ $row->purchase_receive_id }}/edit"
                            title="แก้ไข">
                            <i class="fas fa-edit"></i> แก้ไข
                        </a>
                        <a class="btn btn-primary btn-sm btn-print mr-2"
                            href="{{ url('/') }}/purchase/receive/{{ $row->purchase_receive_id }}/pdf"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="purchase_receive_code" id="purchase_receive_code" class="form-control form-control-sm"
                    disabled>
            </div>
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3 form-inline">
                <input name="external_reference_doc" id="external_reference_doc" class="form-control form-control-sm"
                    required>
                <label class="col-lg-2  offset-lg-1" for="file" id="label_file"><a href="javascript:void(0)"
                        class="btn btn-success btn-sm" onclick="$('#label_file').click();">อัพโหลด </a></label>
                ...
                @endif
                <input type="file" class="d-none" id="file" name="file" value="......"
                    onchange="document.querySelector('#file_name').innerHTML = this.value">
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="internal_reference_doc" id="internal_reference_doc" class="form-control form-control-sm"
                    readonly>
            ...
            <div class="col-lg-3">
                <input type="number" name="billing_duration" id="billing_duration"
                    class="form-control form-control-sm form-control-line d-none" value="30">
            </div>
        </div>
