	...
	<div class="card-body">
      ...
      function createRow(id,element){
        ...
        return [
          ...
          "<input class='input amount_receive_edit "+amount_class+"' name='amount_receive_edit[]'  value='0' type='number' min='1' max='"+element.amount_pending_in+"' data-limit='"+element.amount_pending_in+"' data-quantity='"+element.quantity+"'>",
          @endif
