<div class="card mt-3" id="table" >
	<div class="card-body">
		...
		<div class="table-responsive">
			<table class="table table-hover text-center" id="table-receive_temporary-detail" style="width:100%"></table>
		</div>
		<script>
			document.addEventListener("DOMContentLoaded", function(event) {
				...
				detail.forEach(function(element,index) {
					...
					var id = element.receive_temporary_detail_id;
      ...
      function createRow(id,element){
        ...
        @if( isset($receive_temporary->receive_temporary_code) )
		  //EDIT MODE
		  @if($receive_temporary->receive_temporary_code != "RTDRAFT")
      ...
      function onChange3(){
        ...
        onChange(document.getElementById("vat_percent"));
			...
			function myFunction(event){
				...
				var want_to_delete = confirm('Are you sure to delete this receive_temporary detail?');
				if(want_to_delete){
      ...
      function refreshDetailTableEvent(){
		...
		<div class="text-center">
			...
			@include('purchase/receive_temporary/create_detail_modal')
