<div class="card">
  ...
  <div class="row mb-4">
      ...
      <div class="col-lg-4 text-center">
        <div class="">
        <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($row->receive_temporary_code, 'C128') }}" alt="barcode"   />
        </div>
        <div class="">
      ...
      <div class="col-lg-4 text-right">
        @if($mode == "edit")
          ...
          <a class="px-2 btn btn-sm btn-success" href="javascript:void(0)" onclick="document.querySelector('#purchase_status_id').value='10'; document.querySelector('#receive_temporary_code').value='';  document.querySelector('#form-submit').click(); console.log(5565);" title="สร้าง">
        ...
        @elseif($mode == "show")
          ...
          <a class="px-2 btn btn-sm btn-warning" href="{{ url('/') }}/purchase/receive_temporary/{{ $row->receive_temporary_id }}/edit" title="แก้ไข" >
            <i class="fas fa-edit"></i>  แก้ไข
          </a>
          @endif
        @endif
        
        <a class="px-2 btn btn-sm btn-primary" href="{{ url('/') }}/purchase/receive_temporary/{{ $row->receive_temporary_id }}/pdf" target="_blank"  title="พิมพ์">
    ...
    <div class="form-group form-inline">
      ...
      <div class="col-lg-3">
      <input type="hidden" name="receive_temporary_id" value="{{ isset($receive_temporary->receive_temporary_id)? $receive_temporary->receive_temporary_id : '' }}" />
        <input name="receive_temporary_code"	id="receive_temporary_code" class="form-control form-control-sm"	readonly>
      </div>
    ...
    <div class="form-group form-inline d-none">
      ...
      <div class="col-lg-3">
      <input type="number" name="receive_time"	id="receive_time" class="form-control form-control-sm form-control-line"  disabled>
      </div>
    ...
    <div class="form-group form-inline">
      ...
      <div class="col-lg-3">
        <select name="receive_type_id" id="receive_type_id" class="form-control form-control-sm" required readonly>
    ...
    <div class="form-group form-inline">
      ...
      <div class="col-lg-3">
        <input type="text" name="purchase_status_id"	id="purchase_status_id"	 class="d-none form-control form-control-sm form-control-line"   value="{{ isset($receive_temporary)? $receive_temporary->purchase_status_id  : '0'  }}" readonly>
        <input type="text" name=""	id=""	 class="d-none form-control form-control-sm form-control-line "   value="{{ isset($receive_temporary)? $receive_temporary->purchase_status->purchase_status_name  : '0'  }}" readonly>
