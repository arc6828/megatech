  ...
  <div class="card-body">
    <div class="row">
      <div class="form-group col-lg-2">
        ...
        <input name="supplier_code"  id="supplier_code" class="form-control form-control-sm " value=""  readonly>
      </div>
      ...
      <div class="form-group col-lg-2  d-none">
        ...
        <select name="supplier_type" id="supplier_type"  class="form-control form-control-sm  ">
          ...
          <option value="{{ $cus->supplier_type_id }}">{{ $cus->supplier_type_name }}</option>
          @endforeach
        </select>
      </div>
    </div>
...
<div class="card mt-4">
  <div class="card-body">
    <h2>รายละเอียดข้อมูลเจ้าหนี้ / บริษัท</h2>
    <div class="row">
      <div class="form-group col-lg-4">
        ...
        @include('supplier/modal-account')
        <div>
