      ...
      <table class="table table-sm table-bordered text-center" id="table">
        ...
        <tbody>
          <tr>
            <td>แผนที่</td>
            <td>
              @if( $supplier->file_map )
              <a class="" href="{{ url('/storage') }}/{{ $supplier->file_map }}"  target="_blank">
              {{ $supplier->file_map }}
              </a>
              @endif
            </td>
          ...
          <tr>
            ...
            <td>
              @if( $supplier->file_cc )
              <a class="" href="{{ url('/storage') }}/{{ $supplier->file_cc }}"   target="_blank">
              {{ $supplier->file_cc }}
              </a>
              @endif
            </td>
          ...
          <tr>
            <td>ใบภพ.20		</td>
            <td>
              @if( $supplier->file_cv_20 )
              <a class="" href="{{ url('/storage') }}/{{ $supplier->file_cv_20 }}"   target="_blank">
                {{ $supplier->file_cv_20 }}
              </a>
              @endif
            </td>
          ...
          <tr>
            ...
            <td>
              @if( $supplier->file_cheque )
              <a class="" href="{{ url('/storage') }}/{{ $supplier->file_cheque }}"   target="_blank">
                {{ $supplier->file_cheque }}
              </a>
              @endif
            </td>
            <td>
