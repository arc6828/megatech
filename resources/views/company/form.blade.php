<div class="form-group {{ $errors->has('thname_company') ? 'has-error' : ''}}">
    <label for="thname_company" class="control-label">{{ 'ชื่อไทยบริษัท' }}</label>
...
<div class="form-group {{ $errors->has('enname_company') ? 'has-error' : ''}}">
    <label for="enname_company" class="control-label">{{ 'ชื่ออังกฤษบริษัท' }}</label>
...
<div class="form-group {{ $errors->has('tal') ? 'has-error' : ''}}">
    <label for="tal" class="control-label">{{ 'เบอร์โทรศัพท์' }}</label>
    <input class="form-control" name="tal" type="string" id="tal" value="{{ isset($company->tal) ? $company->tal : ''}}" >
    {!! $errors->first('tal', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('fax') ? 'has-error' : ''}}">
    <label for="fax" class="control-label">{{ 'เบอร์แฟกซ์' }}</label>
    <input class="form-control" name="fax" type="string" id="fax" value="{{ isset($company->fax) ? $company->fax : ''}}" >
    {!! $errors->first('fax', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('number_tex') ? 'has-error' : ''}}">
    <label for="number_tex" class="control-label">{{ 'เลขประจำตัวผู้เสียภาษี' }}</label>
    <input class="form-control" name="number_tex" type="string" id="number_tex" value="{{ isset($company->number_tex) ? $company->number_tex : ''}}" >
    {!! $errors->first('number_tex', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    <label for="image" class="control-label">{{ 'โลโก้' }}</label>
