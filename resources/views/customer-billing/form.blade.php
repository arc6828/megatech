    ...
    <div class="card-body">
        ...
        <div class="form-row form-group text-center pr-5">
            ...
            <input class="col-lg-3 form-control form-control-sm"
                value="{{ isset($customerbilling->created_at) ? $customerbilling->created_at : '' }}" readonly>
        </div>
        @php
        ...
        <div class="form-row form-group text-center pr-5">
            ...
            <input class="col-lg-3 form-control form-control-sm" name="date_billing" type="date" id="date_billing"
                value="{{ isset($customerbilling->date_billing) ? $customerbilling->date_billing : '' }}">
            ...
            <div class="form-group col-lg-3 d-none {{ $errors->has('condition_billing') ? 'has-error' : '' }}">
                ...
                <input class="form-control form-control-sm" name="condition_billing" type="text" id="condition_billing"
                    value="{{ isset($customerbilling->condition_billing) ? $customerbilling->condition_billing : $condition_billing }}">
        ...
        <div class="form-row form-group text-center pr-5">
            ...
            <input class="col-lg-3 form-control form-control-sm" name="condition_cheque" type="text"
                id="condition_cheque"
                value="{{ isset($customerbilling->condition_cheque) ? $customerbilling->condition_cheque : $condition_cheque }}">

            <label for="date_cheque" class="col-lg-3 control-label">{{ 'วันนัดรับเช็ค' }}</label>
            <input class="col-lg-3 form-control form-control-sm" name="date_cheque" type="date" id="date_cheque"
    ...
    <div class="card-body">
        <div class="form-group form-row text-center pr-5">
            ...
            <textarea class="col-lg-3  form-control form-control-sm" rows="2" name="remark" type="textarea"
                id="remark">{{ isset($customerbilling->remark) ? $customerbilling->remark : '' }}</textarea>
