...
<form action="#" id="form-billing" method="POST">
                ...
                <div class="col-lg-6">
                        <div class="form-group form-inline">
                            <label class="col-lg-3">เลขที่เอกสาร</label>
                                <div class="col-lg-3">
                                    <input type="text" name="billing_note_code"  class="form-control form-control-line" value="{{ $row->billing_note_code }}" >
                                </div>
                         </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group form-inline">
                         <label class="col-lg-3">วันที่</label>
                            <div class="col-lg-3">
                                <input type="date" name="date"  class="form-control form-control-line" value="{{ $row->date }}" >
                            </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row">
              <div class="col-lg-6">
                  <div class="form-group form-inline">
                      ...
                      <div class="col-lg-3">
                        <input type="text" name="billing_condition" class="form-control form-control-line" value="{{ $row->billing_condition }}">
                      </div>
                  </div>
              </div>
              <div class="col-lg-6">
                  <div class="form-group form-inline">
                      ...
                      <div class="col-lg-3">
                          <input type="text" name="payment_condition" class="form-control form-control-line" value="{{ $row->payment_condition }}">
                      </div>
                  </div>
              </div>
          </div>
          <div class="row">
                <div class="col-lg-6">
                    <div class="form-group form-inline">
                        ...
                        <div class="col-lg-5">
                          <input type="date" name="billing_date" class="form-control form-control-line" value="{{ $row->billing_date }}">
                        </div>
                ...
                <div class="col-lg-6">
                        <div class="form-group form-inline">
                            ...
                            <div class="col-lg-5">
                              <input type="date" name="cheque_date" class="form-control form-control-line" value="{{ $row->cheque_date }}">
                            </div>
          ...
          <div class="row">
            <div class="col-lg-9">
                    <div class="form-group form-inline">
                            ...
                            <div class="col-lg-7">
                                    <input type="text" name="remark" class="form-control form-control-line" style="width:100%" value="{{ $row->remark }}">
                            </div>  
                      </div>
            </div>
          </div>
          <div class="row">
              <div class="col-lg-6">
                  <div class="form-group form-inline">
                    ...
                    <div class="col-lg-5">
                        <input type="text" name="user_id" id="user_id" class="form-control form-control-line" value="{{ $row->user_id }}">
                    </div>
    ...
    <a href="javascript:void(0)" onclick="summitform({{ $row->billing_note_id }})" class="btn btn-success">Save</button>
