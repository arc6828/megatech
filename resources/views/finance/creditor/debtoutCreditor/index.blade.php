...
@section('title','ตั้งหนี้ยอดหนี้คงค้าง')

@section('navbar-menu')
<div style="margin:21px;">
	<a href="{{ url('/') }}/finance/creditor/debtout/create" class="btn pull-right hidden-sm-down btn-success btn-sm">
		<i class="fa fa-plus"></i> เพิ่มการตั้งหนี้ยอดหนี้คงค้าง
	</a>
<div>
@endsection
...
<div class="row">
    <div class="col-lg-6 align-self-center">
        <h4 class="card-title">ตั้งหนี้ยอดหนี้คงค้าง</h4>
        <h6 class="card-subtitle">Display infomation in the table</h6>
    </div>
    <div class="col-lg-6 align-self-center">
        <form class="" action="{{ url('/') }}/finance/creditor/debtout" method="GET">
...
<script>
	function onDelete(id){
		...
		form.action = "{{ url('/') }}/finance/settle/"+id;
