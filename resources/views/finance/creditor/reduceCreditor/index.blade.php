...
<div style="margin:21px;">
	<a href="{{ url('/') }}/finance/creditor/reduce/create" class="btn pull-right hidden-sm-down btn-success btn-sm">
		<i class="fa fa-plus"></i> ลดหนี้เจ้าหนี้
	</a>
<div>
@endsection
...
<div class="row">
    <div class="col-lg-6 align-self-center">
        <h4 class="card-title">ลดหนี้เจ้าหนี้</h4>
        <h6 class="card-subtitle">Display infomation in the table</h6>
    </div>
    <div class="col-lg-6 align-self-center">
        <form class="" action="{{ url('/') }}/finance/creditor/reduce" method="GET">
...
<script>
	function onDelete(id){
		...
		form.action = "{{ url('/') }}/finance/creditor/reduce/"+id;
