    ...
    <div class="card">
        <div class="card-block">
            ...
            <div class="row">
                <div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group form-inline">
                        <label class="col col-sm-5 col-md-4 col-lg-3 col-xl-3">รหัสลูกค้า</label>
            ...
            <div class="row">
                ...
                <div class="row">
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group form-inline">
                                <label class="col col-sm-6 col-md-6 col-lg-4 col-xl-4">มูลค่าฐานภาษี</label>
                                <div class="col col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                    <input type="text" name="" class="form-control form-control-line">
                                </div>
                                {{-- Modal ???? --}}
                        ...
                        <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group form-inline">
                                <label class="col col-sm-6 col-md-6 col-lg-4 col-xl-4">ยื่นภาษีในงวด</label>
                                <div class="col col-sm-3 col-md-3 col-lg-3 col-xl-3">
...
<a href="javascript:void(0)" onclick="submitForm({{ $row->reduce_id }})" class="btn btn-success">Save</a>
