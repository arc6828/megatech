  ...
  <div class="card-block">      
    <div class="row text-center">
      <div class="col-6 col-md-3">
        <a class="btn btn-outline-dark btn-menu  my-3" href="{{url('/')}}/finance/bank-account">
          <div class="vertical-center">
            <div class="px-4"><i class="round round-dark my-2 ni ni-single-copy-04"></i></div>
      ...
      <div class="col-6 col-md-3">
        <a class="btn btn-outline-info btn-menu  my-3" href="{{url('/')}}/finance/bank-transaction?transaction_code=cash-transfer-in">
          <div class="vertical-center">
            <div class="px-4"><i class="round round-info my-2 ni ni-single-copy-04"></i></div>
      ...
      <div class="col-6 col-md-3">
        <a class="btn btn-outline-info btn-menu  my-3" href="{{url('/')}}/finance/bank-transaction?transaction_code=cash-transfer-out">
          <div class="vertical-center">
            <div class="px-4"><i class="round round-info my-2 ni ni-single-copy-04"></i></div>
