	...
	<div class="card-block">
		<div class="row">
			<div class="col-lg-6 align-self-center">
				<h4 class="card-title">Invoice code :
					@foreach($table_invoice as $row_invoice)
					{{ $row_invoice->invoice_code }}
					@endforeach
				</h4>
				<h6 class="card-subtitle">Fill infomation in the form</h6>
			</div>
			<div class="col-lg-6 align-self-center">
				<form class="" action="{{ url('/') }}/sales/invoice/{{ $invoice_id }}/invoice_detail/create" method="GET">
			...
			<div class="table-responsive">
				<table class="table table-hover text-center">
					...
					<tbody>
						...
						<form action="{{ url('/') }}/sales/invoice/{{$invoice_id}}/invoice_detail" method="POST">
						{{ csrf_field() }}
					    {{ method_field('POST') }}
...
<div class="form-group">
	<div class="col-lg-12">
		<div class="text-center">
	  		<a class="btn btn-outline-primary" href="{{ url('/') }}/sales/invoice/{{ $invoice_id }}/invoice_detail">back</a>
		</div>
	</div>
</div>
