...
@forelse($table_invoice_detail as $row)
<form action="{{ url('/') }}/sales/invoice/{{ $row->invoice_id }}/invoice_detail/{{ $row->invoice_detail_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="card">
		<div class="card-block">
			<div class="row">
				<div class="col-lg-9 align-self-center">
					<h4 class="card-title">Invoice detail id : {{ $row->invoice_detail_id }} </h4>
