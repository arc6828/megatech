                    ...
                    <tbody>
                        @foreach ($table_quotation as $row)
                            <tr>
                                ...
                                <td>
                                    <a href2="{{ url('/customer') }}/{{ $row->Customer->customer_id }}/edit"
                                        target="_blank">
                                        {{ $row->company_name }}
                                    </a>
                                </td>
                                <td class="text-right">{{ number_format($row->total ? $row->total : 0, 2) }}</td>
                                <td><a href2="{{ url('/user') }}/{{ $row->user_id }}" title="{{ $row->name }}"
                                ...
                                <td>
                                    ...
                                    @elseif( $row->sales_status_id == -1 )
                                        <span
                                            class="badge badge-pill badge-secondary">{{ $row->sales_status_name }}</span>
                                ...
                                <td class="d-none">
                                    <a href="javascript:void(0)" onclick="onDelete( {{ $row->quotation_id }} )"
                                        class="text-danger">
