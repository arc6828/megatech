...
@forelse($table_requisition_detail as $row)
<form action="{{ url('/') }}/sales/requisition/{{ $row->requisition_id }}/requisition_detail/{{ $row->requisition_detail_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="card">
		<div class="card-block">
			<div class="row">
				<div class="col-lg-9 align-self-center">
					<h4 class="card-title">Requisition detail id : {{ $row->requisition_detail_id }} </h4>
