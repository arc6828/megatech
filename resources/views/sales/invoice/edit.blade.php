...
<form id="form-delete" style="display: none;" action="{{ url('/') }}/sales/invoice/{{ $row->invoice_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('DELETE') }}
...
<form class="" action="{{ url('/') }}/sales/invoice/{{ $row->invoice_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="card">
		<div class="card-block">
			...
			<div class="col-lg-9 align-self-center">
				<h4 class="card-title">Invoice code : {{ $row->invoice_code }}</h4>
