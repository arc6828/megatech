<div class="card ">
    <div class="card-body">
                ...
                @if (isset($invoice))
                    @if ($mode == 'show')
                        <div class="text-center"><img
                                src="data:image/png;base64,{{ DNS1D::getBarcodePNG($row->invoice_code, 'C128') }}"
                                alt="barcode" /></div>
                ...
                @if (isset($invoice))
                    @if ($mode == 'show')
                        <a class="btn btn-primary btn-sm btn-print mr-2"
                            href="{{ url('/') }}/sales/invoice/{{ $row->invoice_id }}/pdf" target="_blank"
                            title="พิมพ์">
                            <i class="fas fa-print"></i> พิมพ์
                        </a>
                        <a class="btn btn-warning btn-sm"
                            href="{{ url('/') }}/sales/invoice/{{ $row->invoice_id }}/edit" title="แก้ไข">
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="internal_reference_id" id="internal_reference_id" class="form-control form-control-sm"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input name="external_reference_id" id="external_reference_id"
                    ...
                    value="{{ isset($invoice->order) ? $invoice->order->external_reference_id : '' }}" required
                    readonly>
                @if (isset($invoice->order))
                    @if (!empty($invoice->order->po_file))
                        <a href="{{ url('storage/' . $invoice->order->po_file) }}" id="po-file-link"
                            target="_blank">ดูไฟล์ P/O</a>
                    @else
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input type="number" name="debt_duration" id="debt_duration"
                    class="form-control form-control-sm form-control-line" readonly>
            </div>
            <label class="col-lg-2 offset-lg-1">วันที่ชำระเงิน</label>
            <div class="col-lg-3">
                <input type="date" name="billing_duration" id="billing_duration"
                    class="form-control form-control-sm form-control-line" readonly>
            </div>
        </div>
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input type="hidden" name="payment_method" id="payment_method"
                    class="form-control form-control-sm form-control-line" readonly required>
            ...
            <div class="col-lg-3">
                <input type="number" name="max_credit" id="max_credit"
                    class="form-control form-control-sm form-control-line" value="100" readonly required>
            </div>
        </div>
