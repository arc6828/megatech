	...
	<div class="card-block">
		<div class="row text-center">
			...
			<a class="btn btn-outline-primary my-3" href="{{url('/')}}/sales/quotation">
				<div class="px-4"><span class="round round-primary my-2"><i class="fas fa-file-alt"></i></span></i></div>
				<div>ใบเสนอ<br>ราคา</div>
			</a>
			</div>
			<div class="col-6 col-md-3 ">
			<a class="btn btn-outline-primary my-3" href="{{url('/')}}/sales/order">
				<div class="px-4"><span class="round round-primary my-2"><i class="fas fa-file-alt"></i></span></div>
				<div><br>ใบรับจอง</div>
			</a>
			</div>
			<div class="col-6 col-md-3 ">
			...
			<a class="btn btn-outline-danger my-3" href="#">
				<div class="px-4"><span class="round round-danger my-2"><i class="fas fa-truck"></i></span></div>
		...
		<div class="row  text-center">
			...
			<a class="btn btn-outline-success my-3" href="{{url('/')}}/user?q=sales">
				<div class="px-4"><i class="round round-success my-2 fas fa-folder-open"></i></div>
