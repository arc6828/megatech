        ...
        <script>
            ...
            function createRow(id, element) {
                ...
                return [
                    ...
                    "<input type='hidden' class='quotation_code_edit' name='quotation_code_edit[]'  value='" +
                    ...
                    .amount + "' style = 'min-width:60px;' > ",

                    "<input class='input roundnum normal_price_edit' name='normal_price_edit[]'  value='" +
                    parseFloat(element.normal_price).toFixed(2) + "' disabled>",
                    "<input type='number' step='any' class='input roundnum discount_percent_edit' name='discount_percent_edit[]' max=" +
                    ...
                    parseFloat(element.discount_price).toFixed(2) + "'>",
                    "<input type='checkbox' class='danger_price_edit' name='danger_price_edit[]' onclick='onChangeDangerPrice(this);' " +
                    checked + " >",
                    "<input class='input  roundnum total_edit total_edit_row' name='total_edit[]'  value='" + (
                        element.discount_price * element.amount) + "' disabled>",
                    @if (isset($order->order_code))
                        "",
                    @else
