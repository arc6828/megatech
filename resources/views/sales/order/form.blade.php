  ...
  <div class="card-body">
    ...
    <div class="form-group form-inline">
      ...
      <div class="col-lg-3 d-none">
        <input type="date" name="delivery_time"	id="delivery_time" class="form-control form-control-sm form-control-line" value="{{ date("Y-m-d") }}">
      </div>
    ...
    <div class="form-group form-inline">
      ...
      <div class="col-lg-3 d-none ">
        <input type="number" name="billing_duration"	id="billing_duration"	 class="form-control form-control-sm form-control-line" value="0" readonly>
      </div>
    </div>
