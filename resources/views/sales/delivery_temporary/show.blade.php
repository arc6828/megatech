    ...
    @forelse($table_delivery_temporary as $row)
                    ...
                    <table style="width:100%; text-align:center;">
                        <tr>
                            <td style="padding: 0px 10px;">
                                <div class="company_name" style="border:1px solid; padding: 10px 0px; ">ใบส่งของชั่วคราว
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="inline" style="width:30%;  ">
                <div class="">
                    <table class="no-padding-cell" border="1"
                        ...
                        <tr>
                            <th>เลขที่</th>
                            <td>{{ $row->delivery_temporary_code }}</td>
                        </tr>
                        <tr>
                            <th>วันที่</th>
                            <td>{{ $row->datetime }}</td>
        ...
        <div style="margin-top:10px;">
            <table border="1" style="border-collapse: collapse; width:100%; text-align:center;">
                ...
                @foreach ($table_delivery_temporary_detail as $row_detail)
                    <tr>
                ...
                @endforeach
                @for ($i = 0; $i < 10 - count($table_delivery_temporary_detail); $i++)
                    <tr>
                        <td><br></td>
                        <td><br></td>
                        <td><br></td>
