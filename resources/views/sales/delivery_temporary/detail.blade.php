<div class="card mt-3" id="table">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover text-center" id="table-delivery_temporary-detail" style="width:100%">
            </table>
        </div>
        <script>
            ...
            function createRow(id, element) {
                ...
                return [
                    ...
                    "' min='" + min_amount + "' max='" + max_amount + "' title='[" + min_amount + "," + max_amount +
                    "]' style='min-width:60px;'>",

                    "<input class='input roundnum normal_price_edit' name='normal_price_edit[]'  value='" + element
                    .normal_price + "' disabled>",
                    "<input type='number' step='any' class='input roundnum discount_percent_edit' name='discount_percent_edit[]' max=" +
                    element.max_discount_percent + "  value='" + (100 - element.discount_price / element.normal_price *
                        100) + "'>",
                    "<input class='input roundnum discount_price_edit' name='discount_price_edit[]'  value='" + element
                    .discount_price + "'>",
                    "<input type='checkbox' name='danger_price_edit[]'>",
                    "<input class='input  roundnum total_edit' name='total_edit[]'  value='" + (element.discount_price *
            ...
            function onChange3() {
                ...
                switch (obj.name) {
                    case "discount_percent_edit[]":
                        ...
                        discount_price_edit.value = normal_price_edit.value - normal_price_edit.value * (discount_percent_edit
                            .value) / 100;
