<div class="card">
    <div class="card-body">
        <div class="row mb-4">
            ...
            @if (isset($table_delivery_temporary))
                <div class="col-lg-4 text-center">
                    <div class="">
                        <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($row->delivery_temporary_code, 'C128') }}"
                            alt="barcode" />
                    </div>
                    <div class="">
                ...
                <div class="col-lg-4 text-right">
                    ...
                    @elseif($mode == "show")
                        @if ($row->sales_status_id != 11)
                            <a class="px-2 btn btn-sm btn-warning"
                                href="{{ url('/') }}/sales/delivery_temporary/{{ $row->delivery_temporary_id }}/edit"
                                title="แก้ไข">
                    ...
                    <a class="px-2 btn btn-sm btn-primary"
                        href="{{ url('/') }}/sales/delivery_temporary/{{ $row->delivery_temporary_id }}/pdf"
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input type="hidden" name="delivery_temporary_id"
                    value="{{ isset($delivery_temporary->delivery_temporary_id) ? $delivery_temporary->delivery_temporary_id : '' }}" />
                <input name="delivery_temporary_code" id="delivery_temporary_code" class="form-control form-control-sm"
                    readonly>
            </div>
        ...
        <div class="form-group form-inline">
            ...
            <div class="col-lg-3">
                <input type="text" name="sales_status_id" id="sales_status_id"
                    class="d-none form-control form-control-sm form-control-line"
                    value="{{ isset($delivery_temporary) ? $delivery_temporary->sales_status_id : '0' }}" readonly>
                <input type="text" name="" id="" class="d-none form-control form-control-sm form-control-line "
                    value="{{ isset($delivery_temporary) ? $delivery_temporary->sales_status->sales_status_name : '0' }}"
                    readonly>
