                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover text-center table-bordered table-striped" id="table">
                                ...
                                <tbody>
                                    @foreach ($returninvoice as $item)
                                        <tr>
                                            <td>
                                                <a class="" href="{{ url('/sales/return-invoice/' . $item->id . '') }}"
                                                    title="Edit ReturnInvoice">
                                                    {{ $item->code }}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                @switch($item->sales_status_id)
                                                    @case("-1")
                                                        <span
                                                            class="badge badge-pill badge-secondary">{{ $item->sales_status->sales_status_name }}</span>
                                                    @break
                                                    @case("6")
                                                        <span
                                                            class="badge badge-pill badge-primary">{{ $item->sales_status->sales_status_name }}</span>
                                                    @break
                                                    @case("15")
                                                        <span
                                                            class="badge badge-pill badge-success">{{ $item->sales_status->sales_status_name }}</span>
                                                    @break
                                                    @default
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <a href="{{ url('/sales/return-invoice/create') }}" class="btn btn-success "
                                    title="Add New ReturnInvoice">
