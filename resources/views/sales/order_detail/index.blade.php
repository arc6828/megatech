...
@section('navbar-menu')
    <div style="margin:21px;">
        ...
        <button class="btn btn-success d-none" type="submit"
            onclick="document.getElementById('form').submit();">Update</button>
    </div>
@endsection
...
@section('content')
        ...
        <div class="card-body">
            ...
            <form method="get" action="">
                <div class="form-group form-inline">
                    ...
                    <div class="col-lg-2">
                        <select name="order_detail_status_id" id="order_detail_status_id"
                    ...
                    <div class="col-lg-2">
                        <input name="approve_date" class="form-control form-control-sm"
                            value="{{ date_format(date_create(date('Y-m-d')), 'd-m-Y') }}" disabled readonly>
                    </div>
                </div>
                ...
                <div class="form-group form-inline d-none">
                    ...
                    <div class="col-lg-2">
                        <select name="m_date" id="m_date" class="form-control form-control-sm" onchange="onSubmit(this);"
                            ...
                            @for ($i = 1; $i <= 12; $i++)
                                <option value="{{ date('Y') }}-{{ sprintf('%02d', $i) }}-01"
                ...
                <div class="form-group form-inline">
                    ...
                    <div class="col-lg-2">
                        <input name="order_id" id="order_id" class="form-control form-control-sm" onchange="onSubmit(this);"
    ...
    <div class="card mt-4">
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-lg-12">
                    <input class="form-control form-control-sm" id="isbn" placeholder="barcode ..."
            ...
            document.addEventListener("DOMContentLoaded", function(event) {
                ...
                $.ajax({
                    ...
                    result.forEach(function(element, index) {
                        ...
                        var row = [
                            "<input type='checkbox' name='selected_order_detail_ids[]' class='' value='" +
                            id + "' >" +
                            ...
                            `<a href2="{{ url('/sales/order') }}/` + element.order_id +
                            `" target="_blank">` + element.order_code + "</a>",
                            ...
                            `<a href2="{{ url('/product') }}/` + element.product_id +
                            `/edit" target="_blank">` + element.product_name + `</a>`,
