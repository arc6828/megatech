	...
	<div class="card-block">
		<div class="row">
			<div class="col-lg-6 align-self-center">
				<h4 class="card-title">Order code :
					@foreach($table_order as $row_order)
			...
			<div class="col-lg-6 align-self-center">
				<form class="" action="{{ url('/') }}/sales/order/{{ $order_id }}/order_detail/create" method="GET">
			...
			<div class="table-responsive">
				<table class="table table-hover text-center">
					...
					<tbody>
						...
						<form action="{{ url('/') }}/sales/order/{{$order_id}}/order_detail" method="POST">
						{{ csrf_field() }}
					    {{ method_field('POST') }}
...
<div class="form-group">
	<div class="col-lg-12">
		<div class="text-center">
	  		<a class="btn btn-outline-primary" href="{{ url('/') }}/sales/order/{{ $order_id }}/order_detail">back</a>
		</div>
	</div>
</div>
