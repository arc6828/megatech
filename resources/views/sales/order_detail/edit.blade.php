...
@forelse($table_order_detail as $row)
<form action="{{ url('/') }}/sales/order/{{ $row->order_id }}/order_detail/{{ $row->order_detail_id }}" method="POST">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="card">
		<div class="card-block">
			<div class="row">
				<div class="col-lg-9 align-self-center">
					<h4 class="card-title">Order detail id : {{ $row->order_detail_id }} </h4>
