	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">แก้ไข Order detail id : <span id="order_detail_id"></span> </h5>
					...
					<div class="form-group">
						<div class="col-lg-12">
							<div class="text-center">
								<a class="btn btn-outline-primary d-none" href="{{ url('/') }}/sales/order/{{ $order_id}}/order_detail">back</a>
