<div class="form-group {{ $errors->has('doc_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="doc_id" type="text" id="doc_id" value="{{ isset($customerbillingdetail->doc_id) ? $customerbillingdetail->doc_id : ''}}" >
...
<div class="form-group {{ $errors->has('customer_billing_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="customer_billing_id" type="number" id="customer_billing_id" value="{{ isset($customerbillingdetail->customer_billing_id) ? $customerbillingdetail->customer_billing_id : ''}}" >
