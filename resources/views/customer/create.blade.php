...
<div class="card">
    <div class="card-block">
            ...
            <div class="col-lg-6">
                <div class="form-group form-inline">
                        <label class="col-lg-2">รหัสลูกค้า</label>
                                <div class="col-lg-3">
                                    <input type="text" name="customer_code"  class="form-control form-control-line"  >
                                </div>
                            </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="form-group form-inline">
            <label class="col-lg-1">ชื่อบริษัท</label>
                <div class="col-lg-11">
                    <input type="text" name="company_name"  class="form-control form-control-line" style="width:100%"  >
                </div>
        </div>
        ...
        <div class="form-group form-inline">
                <label class="col-lg-2">รายชื่อผู้ติดต่อ</label>
                        <div class="col-lg-3">
                            <input type="text" name="contact_name"  class="form-control form-control-line" style="width: 100%" >
                        </div>
         </div>
         <div class="form-group form-inline">
                <label class="col-lg-2">ที่อยู่</label>
                        <div class="col-lg-3">
                            <input type="text" name="address"  class="form-control form-control-line" style="width: 100%" ><br>
                        </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">ตำบล</label>
                        <div class="col-lg-3">
                            <input type="text" name="sub_district"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">อำเภอ</label>
                        <div class="col-lg-3">
                            <input type="text" name="district"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">จังหวัด</label>
                        <div class="col-lg-3">
                            <input type="text" name="province"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">รหัสไปรษณีย์</label>
                        <div class="col-lg-3">
                            <input type="text" name="zipcode"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">สถานที่ส่งของ</label>
                        <div class="col-lg-3">
                            <input type="text" name="delivery_address"  class="form-control form-control-line" style="width: 100%" ><br>
                        </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">ตำบลที่ส่งของ</label>
                        <div class="col-lg-3">
                            <input type="text" name="delivery_sub_district"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">อำเภอที่ส่งของ</label>
                        <div class="col-lg-3">
                            <input type="text" name="delivery_district"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">จังหวัดที่ส่งของ</label>
                        <div class="col-lg-3">
                            <input type="text" name="delivery_province"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
        ...
        <div class="form-group form-inline">
                <label class="col-lg-2">เบอร์โทรศัพท์</label>
                        <div class="col-lg-3">
                            <input type="text" name="telephone"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">เบอร์ FAX</label>
                        <div class="col-lg-3">
                            <input type="text" name="fax"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
        ...
        <div class="form-group form-inline">
                <label class="col-lg-2">หมายเหตุ</label>
                        <div class="col-lg-3">
                            <input type="text" name="remark"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">วงเงินเคดิต</label>
                        <div class="col-lg-3">
                            <input type="number" name="max_credit"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">ระยะเวลาหนี้</label>
                        <div class="col-lg-3">
                            <input type="number" name="debt_duration"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">ระดับของราคาสินค้า</label>
                        <div class="col-lg-3">
                            <input type="number" name="degree_product"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">ส่วนลด </label>
                        <div class="col-lg-3">
                            <input type="number" name="loyalty_discount"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">เลขภาษี </label>
                        <div class="col-lg-3">
                            <input type="text" name="tax_number"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">เงื่อนไขวางบิล </label>
                        <div class="col-lg-3">
                            <input type="text" name="billing_condition"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
                <label class="col-lg-2">เงื่อนไขรับเช็ค </label>
                        <div class="col-lg-3">
                            <input type="text" name="cheqe_condition"  class="form-control form-control-line" style="width: 100%" ><br>
                </div>
        </div>
        <div class="form-group form-inline">
    ...
    <div class="form-group form-inline">
            <label class="col-lg-2">สำนักงาน/สาขา (แสดงในภาษี) </label>
                    <div class="col-lg-3">
                        <input type="text" name="branch_id"  class="form-control form-control-line" style="width: 100%" ><br>
            </div>
    </div>
