...
<div class="row">
  ...
  <div class="col-sm-6">
        <div class="form-group {{ $errors->has('debt_duration') ? 'has-error' : ''}}">
            ...
            <input class="form-control form-control-sm" name="debt_duration" type="text" id="debt_duration" value="{{ isset($customerdebt->debt_duration) ? $customerdebt->debt_duration : ''}}" >
...
<div class="row">
  ...
  <div class="col-sm-6">
        <div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
            ...
            <input class="form-control form-control-sm" name="user_id" type="number" id="user_id" value="{{ isset($customerdebt->user_id) ? $customerdebt->user_id : ''}}" >
...
<div class="row">
  ...
  <div class="col-sm-6">
        <div class="form-group {{ $errors->has('role') ? 'has-error' : ''}}">
            ...
            <input class="form-control form-control-sm" name="role" type="text" id="role" value="{{ isset($customerdebt->role) ? $customerdebt->role : ''}}" >
...
<div class="row">
  ...
  <div class="col-sm-6">
        <div class="form-group {{ $errors->has('zone_id') ? 'has-error' : ''}}">
            ...
            <input class="form-control form-control-sm" name="zone_id" type="number" id="zone_id" value="{{ isset($customerdebt->zone_id) ? $customerdebt->zone_id : ''}}" >
  ...
  <div class="col-sm-6">
        <div class="form-group {{ $errors->has('reference') ? 'has-error' : ''}}">
            ...
            <input class="form-control form-control-sm" name="reference" type="text" id="reference" value="{{ isset($customerdebt->reference) ? $customerdebt->reference : ''}}" >
...
<div class="row">
  ...
  <div class="col-sm-4">
      <div class="form-group {{ $errors->has('discount') ? 'has-error' : ''}}">
          ...
          <input class="form-control form-control-sm" name="discount" type="number" id="discount" value="{{ isset($customerdebt->discount) ? $customerdebt->discount : ''}}" >
