<div class="card mb-4">
    <div class="card-body text-center pr-5">
        ...
        <div class="form-row form-group {{ $errors->has('amount') ? 'has-error' : ''}}">
            ...
            <div class="col-lg-6  input-group input-group-sm ">
                <div class="input-group-prepend">
                    <span class="input-group-text" name="product_code" id="product_code"></span>
                </div>
                <input class="form-control" name="product_name" id="product_name" readonly="" >
            ...
            <label for="amount" class="col-lg-2 control-label">{{ 'จำนวน' }}</label>
            <input class="col-lg-1 form-control form-control-sm" name="amount" type="text" id="amount" value="{{ isset($issuestock->amount) ? $issuestock->amount : '1'}}" min="1">
        ...
        <div class="form-row form-group {{ $errors->has('amount') ? 'has-error' : ''}}">
            ...
            <input class="col-lg-3 form-control form-control-sm" type="text" value="{{ isset($issuestock->user_id) ? $issuestock->user->short_name : Auth::user()->name }}" readonly>
