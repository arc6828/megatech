...
<div class="form-group {{ $errors->has('floor_price') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('max_discount_percent') ? 'has-error' : ''}}">
    <label for="max_discount_percent" class="control-label">{{ 'Max Discount Percent' }}</label>
...
<div class="form-group {{ $errors->has('product_unit') ? 'has-error' : ''}}">
    <label for="product_unit" class="control-label">{{ 'Product Unit' }}</label>
...
<div class="form-group {{ $errors->has('normal_price') ? 'has-error' : ''}}">
    <label for="normal_price" class="control-label">{{ 'Normal Price' }}</label>
...
<div class="form-group {{ $errors->has('purchase_ref') ? 'has-error' : ''}}">
