...
<head>
    ...
    <link href="{{ url('/') }}/argon-dashboard-v1.0.0/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css"
        rel="stylesheet">
    <!-- Argon CSS -->

    <link type="text/css" href="{{ url('/') }}/argon-dashboard-v1.0.0/assets/css/argon.css?v=1.0.0"
        rel="stylesheet">
...
<body style="background-color: #e9ecef;">
    ...
    <script src="{{ url('/') }}/argon-dashboard-v1.0.0/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js">
    </script>
    <!-- Sidenav -->
