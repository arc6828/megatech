<div class="form-group {{ $errors->has('doc_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="doc_id" type="text" id="doc_id" value="{{ isset($supplierpaymentdetail->doc_id) ? $supplierpaymentdetail->doc_id : ''}}" >
...
<div class="form-group {{ $errors->has('supplier_billing_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="supplier_billing_id" type="number" id="supplier_billing_id" value="{{ isset($supplierpaymentdetail->supplier_billing_id) ? $supplierpaymentdetail->supplier_billing_id : ''}}" >
