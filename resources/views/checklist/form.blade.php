<div class="form-group {{ $errors->has('billing_invoice') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_invoice" type="text" id="billing_invoice" value="{{ isset($checklist->billing_invoice) ? $checklist->billing_invoice : ''}}" >
...
<div class="form-group {{ $errors->has('billing_po') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_po" type="text" id="billing_po" value="{{ isset($checklist->billing_po) ? $checklist->billing_po : ''}}" >
...
<div class="form-group {{ $errors->has('billing_receipt') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_receipt" type="text" id="billing_receipt" value="{{ isset($checklist->billing_receipt) ? $checklist->billing_receipt : ''}}" >
...
<div class="form-group {{ $errors->has('billing_envelope') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_envelope" type="text" id="billing_envelope" value="{{ isset($checklist->billing_envelope) ? $checklist->billing_envelope : ''}}" >
...
<div class="form-group {{ $errors->has('billing_delivery') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_delivery" type="text" id="billing_delivery" value="{{ isset($checklist->billing_delivery) ? $checklist->billing_delivery : ''}}" >
...
<div class="form-group {{ $errors->has('billing_reference') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="billing_reference" type="text" id="billing_reference" value="{{ isset($checklist->billing_reference) ? $checklist->billing_reference : ''}}" >
...
<div class="form-group {{ $errors->has('cheque_billing') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cheque_billing" type="text" id="cheque_billing" value="{{ isset($checklist->cheque_billing) ? $checklist->cheque_billing : ''}}" >
...
<div class="form-group {{ $errors->has('cheque_receipt') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cheque_receipt" type="text" id="cheque_receipt" value="{{ isset($checklist->cheque_receipt) ? $checklist->cheque_receipt : ''}}" >
...
<div class="form-group {{ $errors->has('cheque_po') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cheque_po" type="text" id="cheque_po" value="{{ isset($checklist->cheque_po) ? $checklist->cheque_po : ''}}" >
    {!! $errors->first('cheque_po', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
    <label for="type" class="control-label">{{ 'Type' }}</label>
    <input class="form-control" name="type" type="text" id="type" value="{{ isset($checklist->type) ? $checklist->type : ''}}" >
    {!! $errors->first('type', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('customer_id') ? 'has-error' : ''}}">
    <label for="customer_id" class="control-label">{{ 'Customer Id' }}</label>
    <input class="form-control" name="customer_id" type="text" id="customer_id" value="{{ isset($checklist->customer_id) ? $checklist->customer_id : ''}}" >
    {!! $errors->first('customer_id', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('supplier_id') ? 'has-error' : ''}}">
    <label for="supplier_id" class="control-label">{{ 'Supplier Id' }}</label>
    <input class="form-control" name="supplier_id" type="text" id="supplier_id" value="{{ isset($checklist->supplier_id) ? $checklist->supplier_id : ''}}" >
