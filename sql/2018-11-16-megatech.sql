...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2018 at 05:04 AM
...
CREATE TABLE `tb_customer` (
  ...
  `zipcode` varchar(100) NOT NULL COMMENT 'รหัสไปรษณีย์',
...
(4, 'sadsaeqwe', '', 'Company A', 11011, 'Name A', 'xxxxx22222', '', '', '', '', 'asdcsae', '', '', '', '', 100, '099-199-4665', '02-9999-9', NULL, 0, 0, 'sadxzcwqesa', 1121, 120120, 12012012, 120120, '1201201', '', '', 0, 0, 1000),
(5, 'axx', 'consumer', 'Company B', 1101, 'Name B', 'dsadsa', '', '', '', '', 'sadrsadr', '', '', '', '', 100, '099-199-4665', '02-9999-99999', NULL, 0, 0, 'sdarwerawe', 50, 50, 50, 50, '50', 'fist_mon', 'fist_mon', 0, 0, 0);
...
--
ALTER TABLE `tb_supplier`
  MODIFY `supplier_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=7;
