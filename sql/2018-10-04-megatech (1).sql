...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2018 at 12:28 PM
...
INSERT INTO `tb_customer` (`customer_id`, `type_customer`, `company_name`, `id_account`, `customer_name`, `address`, `place_delivery`, `id_user`, `telephone`, `sales_area`, `transpot`, `note`, `credit`, `debt_period`, `degree_product`, `deposit_discount`, `tax_number`, `bill_condition`, `check_condition`, `location`, `branch`, `fax_number`, `debt_balance`) VALUES
(4, '', 'Company A', 11011, 'Name A', 'xxxxx22222', 'asdcsae', '100', '099-199-4665', '', '', 'sadxzcwqesa', 1121, 120120, 12012012, 120120, 1201201, '', '', '', 'สำนักงานใหญ่', '02-9999-9', 1000),
(5, 'consumer', 'Company B', 1101, 'Name B', 'dsadsa', 'sadrsadr', '100', '099-199-4665', 'bankok', 'postoffice', 'sdarwerawe', 50, 50, 50, 50, 50, 'fist_mon', 'fist_mon', 'headquarters', 'สำนักงานใหญ่', '02-9999-99999', 0);
...
CREATE TABLE `tb_quotation` (
  ...
  `total_before_vat` float NOT NULL COMMENT 'ยอดรวม',
  `vat_percent` float NOT NULL DEFAULT '7' COMMENT 'อัตราภาษี %',
  `vat` float NOT NULL COMMENT 'มูลค่าภาษี (บาท)',
  `net_price` float NOT NULL COMMENT 'ยอดสุทธิ (บาท)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_quotation` (`quotation_id`, `quotation_code`, `datetime`, `customer_id`, `debt_duration`, `billing_duration`, `payment_condition`, `delivery_type_id`, `tax_type_id`, `delivery_time`, `department_id`, `sales_status_id`, `user_id`, `zone_id`, `remark`, `total_before_vat`, `vat_percent`, `vat`, `net_price`) VALUES
(1, 'QT4801-00001', '2018-09-13 00:00:00', '4', 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0, 7, 0, 0),
(2, 'QT4801-00002', '2018-09-13 00:00:00', '4', 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0, 7, 0, 0),
(3, 'QT1810-00001', '2018-10-02 17:16:49', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 7, 0, 0),
(4, 'QT1810-00002', '2018-10-02 17:19:09', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 7, 0, 0),
(5, 'QT1810-00003', '2018-10-02 17:19:32', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 7, 0, 0),
(6, 'QT1810-00004', '2018-10-03 10:38:17', '4', 1, 1, '1', 1, 2, 1, NULL, 2, 4, 1, '1', 0, 7, 0, 0),
(7, 'QT6110-00005', '2018-10-03 10:42:25', '4', 1, 1, '1', 1, 2, 1, NULL, 2, 4, 2, '1', 0, 7, 0, 0),
(8, 'QT6110-00006', '2018-10-03 10:44:44', '4', 1, 1, '1', 1, 2, 1, NULL, 2, 4, 2, '1', 0, 7, 0, 0);
...
INSERT INTO `tb_quotation_detail` (`quotation_detail_id`, `product_id`, `product_detail`, `amount`, `discount_price`, `quotation_id`) VALUES
(1, '1', NULL, 1, 0, 1),
(2, '2', NULL, 1, 0, 1),
(3, '3', NULL, 1, 0, 1),
(4, '1', NULL, 1, 0, 1),
...
--
ALTER TABLE `tb_quotation`
  MODIFY `quotation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tb_quotation_detail`
--
ALTER TABLE `tb_quotation_detail`
  MODIFY `quotation_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id', AUTO_INCREMENT=9;
