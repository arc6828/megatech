...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2018 at 04:55 AM
...
INSERT INTO `tb_customer` (`customer_id`, `type_customer`, `company_name`, `id_account`, `customer_name`, `address`, `place_delivery`, `id_user`, `telephone`, `sales_area`, `transpot`, `note`, `credit`, `debt_period`, `degree_product`, `deposit_discount`, `tax_number`, `bill_condition`, `check_condition`, `location`, `branch`, `fax_number`, `debt_balance`, `email`) VALUES
(4, '', 'Company A', 11011, 'Name A', 'xxxxx22222', 'asdcsae', '100', '099-199-4665', '', '', 'sadxzcwqesa', 1121, 120120, 12012012, 120120, 1201201, '', '', '', 'สำนักงานใหญ่', '02-9999-9', 1000, NULL),
(5, 'consumer', 'Company B', 1101, 'Name B', 'dsadsa', 'sadrsadr', '100', '099-199-4665', 'bankok', 'postoffice', 'sdarwerawe', 50, 50, 50, 50, 50, 'fist_mon', 'fist_mon', 'headquarters', 'สำนักงานใหญ่', '02-9999-99999', 0, NULL);
...
CREATE TABLE `tb_product` (
  ...
  `product_unit` varchar(10) NOT NULL DEFAULT 'ชิ้น'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_product` (`product_id`, `product_code`, `product_name`, `product_detail`, `normal_price`, `promotion_price`, `amount_in_stock`, `product_unit`) VALUES
(1, 'FIN-01', 'สินค้าสำเร็จรูป', NULL, 100, 200, 0, 'ชิ้น'),
(2, '01431-SAE', 'ชุดผ้าเบรค', NULL, 100, NULL, 0, 'ชิ้น'),
(3, 'PRO-01', 'ลูกสูบ', NULL, 100, NULL, 0, 'ชิ้น');
...
(1, 'QT4801-00001', '2018-09-13 00:00:00', 4, 7, 15, NULL, 1, 2, 60, 0, 3, 4, 1, NULL, 0),
...
INSERT INTO `tb_quotation_detail` (`quotation_detail_id`, `product_id`, `amount`, `discount_price`, `quotation_id`) VALUES
(5, 1, 10, 60, 1),
(6, 1, 1, 100, 1),
(7, 1, 1, 100, 1),
(8, 1, 10, 90, 1),
...
CREATE TABLE `tb_requisition` (
  `requisition_id` int(11) NOT NULL COMMENT 'id',
  `requisition_code` varchar(20) DEFAULT NULL COMMENT 'เลขที่ใบเสนอราคา',
  `datetime` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'วันที่เวลา',
  `customer_id` int(11) NOT NULL COMMENT 'รหัสลูกค้า',
  `debt_duration` int(11) NOT NULL COMMENT 'ระยะเวลาหนี้ (วัน)',
  `billing_duration` int(11) NOT NULL COMMENT 'กำหนดยื่นราคา (วัน)',
...
INSERT INTO `tb_requisition` (`requisition_id`, `requisition_code`, `datetime`, `customer_id`, `debt_duration`, `billing_duration`, `payment_condition`, `delivery_type_id`, `tax_type_id`, `delivery_time`, `department_id`, `sales_status_id`, `user_id`, `zone_id`, `remark`, `vat_percent`) VALUES
(1, 'RQ4801-00001', '2018-09-13 00:00:00', 4, 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0),
(2, 'RQ4801-00002', '2018-09-13 00:00:00', 4, 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0),
(3, 'RQ1810-00001', '2018-10-02 17:16:49', 4, 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0),
(4, 'RQ1810-00002', '2018-10-02 17:19:09', 4, 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0),
(5, 'RQ1810-00003', '2018-10-02 17:19:32', 4, 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0),
(6, 'RQ1810-00004', '2018-10-03 10:38:17', 4, 1, 1, '1', 1, 2, 1, NULL, 2, 4, 1, '1', 0),
(7, 'RQ6110-00005', '2018-10-03 10:42:25', 4, 1, 1, '1', 1, 2, 1, NULL, 2, 4, 2, '1', 0),
(8, 'RQ6110-00006', '2018-10-03 10:44:44', 4, 1, 1, '1', 1, 2, 1, NULL, 2, 4, 2, '1', 0),
(9, 'RQ6110-00007', '2018-10-05 16:55:19', 5, 1, 1, '1', 1, 2, 1, NULL, 1, 4, 2, '1', 8);
...
CREATE TABLE `tb_requisition_detail` (
  `requisition_detail_id` int(11) NOT NULL COMMENT '_id',
  `product_id` int(11) NOT NULL COMMENT 'รหัสสินค้า',
  `amount` int(11) NOT NULL DEFAULT '1' COMMENT 'จำนวน',
  `discount_price` float DEFAULT NULL COMMENT 'ราคาขาย (บาท)',
  `requisition_id` int(11) NOT NULL COMMENT 'เลขที่ใบเสนอราคา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_requisition_detail` (`requisition_detail_id`, `product_id`, `amount`, `discount_price`, `requisition_id`) VALUES
(5, 1, 1, 0, 1),
(6, 1, 1, 100, 1),
(7, 1, 1, 100, 1),
(8, 1, 10, 90, 1),
...
--
ALTER TABLE `tb_quotation_detail`
  MODIFY `quotation_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tb_requisition`
--
ALTER TABLE `tb_requisition`
  MODIFY `requisition_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tb_requisition_detail`
--
ALTER TABLE `tb_requisition_detail`
  MODIFY `requisition_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id', AUTO_INCREMENT=12;
