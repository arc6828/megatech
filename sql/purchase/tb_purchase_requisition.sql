...
--
-- Table structure for table `tb_pruchase_requisition`
--

CREATE TABLE `tb_pruchase_requisition` (
  `pruchase_requisition_id` int(11) NOT NULL COMMENT 'id',
  `pruchase_requisition_code` varchar(20) DEFAULT NULL COMMENT 'เลขที่เอกสาร',
...
--
-- Dumping data for table `tb_pruchase_requisition`
--

INSERT INTO `tb_pruchase_requisition` (`pruchase_requisition_id`, `pruchase_requisition_code`, `datetime`, `customer_id`, `debt_duration`, `billing_duration`, `payment_condition`, `delivery_type_id`, `tax_type_id`, `delivery_time`, `department_id`, `sales_status_id`, `user_id`, `zone_id`, `remark`, `vat_percent`, `internal_reference_doc`, `external_reference_doc`) VALUES
...
--
-- Indexes for table `tb_pruchase_requisition`
--
ALTER TABLE `tb_pruchase_requisition`
  ADD PRIMARY KEY (`pruchase_requisition_id`);
...
--
-- AUTO_INCREMENT for table `tb_pruchase_requisition`
--
ALTER TABLE `tb_pruchase_requisition`
  MODIFY `pruchase_requisition_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=10;
COMMIT;
