...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2018 at 12:44 PM
...
INSERT INTO `tb_quotation` (`quotation_id`, `quotation_code`, `datetime`, `customer_id`, `debt_duration`, `billing_duration`, `payment_condition`, `delivery_type_id`, `tax_type_id`, `delivery_time`, `department_id`, `sales_status_id`, `user_id`, `zone_id`, `remark`, `total`, `tax_rate`, `tax`, `total_tax`) VALUES
(1, 'QT4801-00001', '2018-09-13 00:00:00', '4', 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0, 0, 0, 0),
(2, 'QT4801-00002', '2018-09-13 00:00:00', '4', 7, 15, '', 1, 2, 0, 0, 3, 4, 1, '', 0, 0, 0, 0),
(3, NULL, '2018-10-02 17:16:49', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 0, 0, 0),
(4, NULL, '2018-10-02 17:19:09', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 0, 0, 0),
(5, NULL, '2018-10-02 17:19:32', '4', 1, 1, '1', 1, 2, 1, NULL, 1, 4, 1, NULL, 0, 0, 0, 0);
...
--
ALTER TABLE `tb_quotation`
  MODIFY `quotation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_quotation_detail`
--
ALTER TABLE `tb_quotation_detail`
  MODIFY `quotation_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id';
