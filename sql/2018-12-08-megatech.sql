...
CREATE TABLE `tb_billing_note` (
  `billing_note_id` int(11) NOT NULL COMMENT 'id',
  `billing_note_code` varchar(20) NOT NULL COMMENT 'เลขที่ใบวางบิล',
  `date` date NOT NULL COMMENT 'วันที่วางบิล',
  `customer_id` int(11) NOT NULL COMMENT 'รหัสลูกค้า',
  `billing_condition` varchar(255) NOT NULL COMMENT 'เงื่อนไขการวางบิล',
  `payment_condition` varchar(255) NOT NULL COMMENT 'เงื่อนไขการชำระ',
  `billing_date` date NOT NULL COMMENT 'วันที่ไปวางบิล',
  `cheque_date` date NOT NULL COMMENT 'วันที่นัดรับเช็ค',
...
CREATE TABLE `tb_order_detail` (
  ...
  `product_id` int(11) NOT NULL COMMENT 'รหัสสินค้า',
  `amount` int(11) NOT NULL DEFAULT '1' COMMENT 'จำนวน',
  `approved_amount` int(11) DEFAULT '0' COMMENT 'จำนวนที่อนุมัติ',
  `discount_price` float DEFAULT NULL COMMENT 'ราคาขาย (บาท)',
  `order_id` int(11) NOT NULL COMMENT 'เลขที่ใบเสนอราคา',
  `order_detail_status_id` int(11) DEFAULT '3'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_order_detail` (`order_detail_id`, `product_id`, `amount`, `approved_amount`, `discount_price`, `order_id`, `order_detail_status_id`) VALUES
(5, 1, 1, 0, 0, 3, 1),
(6, 1, 1, 0, 100, 3, 1),
(7, 1, 1, 0, 100, 3, 1),
(8, 1, 10, 0, 90, 3, 1),
...
(3, 'QT1810-00001', '2018-10-02 17:16:49', 4, 120120, 1, 'ภายใน 30 วัน', 1, 2, 1, 1, 1, 4, 1, 'ไม่มี', 7, NULL, NULL),
...
--
-- Indexes for table `tb_billing_receipt`
--
ALTER TABLE `tb_billing_receipt`
  ADD PRIMARY KEY (`billing_receipt_id`);

--
-- Indexes for table `tb_cheque`
--
...
--
-- Indexes for table `tb_order_detail_status`
--
ALTER TABLE `tb_order_detail_status`
  ADD PRIMARY KEY (`order_detail_status_id`);
...
--
ALTER TABLE `tb_billing_note`
  MODIFY `billing_note_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id';

--
-- AUTO_INCREMENT for table `tb_billing_receipt`
--
ALTER TABLE `tb_billing_receipt`
  MODIFY `billing_receipt_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id';

--
-- AUTO_INCREMENT for table `tb_cheque`
--
ALTER TABLE `tb_cheque`
  MODIFY `cheque_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id';
...
--
ALTER TABLE `tb_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_order_detail`
--
ALTER TABLE `tb_order_detail`
  MODIFY `order_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_order_detail_status`
--
ALTER TABLE `tb_order_detail_status`
  MODIFY `order_detail_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_quotation`
  MODIFY `quotation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_quotation_detail`
--
ALTER TABLE `tb_quotation_detail`
  MODIFY `quotation_detail_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '_id', AUTO_INCREMENT=29;
