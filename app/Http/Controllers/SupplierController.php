...
class SupplierController extends Controller
{
  ...
  public function create()
  {
    ...
    $table_zone = DB::table('tb_zone')->get();
    $table_delivery_type = DB::table('tb_delivery_type')->get();
    $table_location = DB::table('tb_location_type')->get();
    $table_supplier_type = DB::table('tb_supplier_type')->get();
    $data = [
