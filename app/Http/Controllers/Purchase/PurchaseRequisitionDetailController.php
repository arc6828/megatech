...
class PurchaseRequisitionDetailController extends Controller
{
  ...
  public function approve(Request $request)
  {
    ...
    PurchaseRequisitionDetailModel::update_purchase_requisition_detail_status_id_by_ids($action, $selected_purchase_requisition_detail_ids,3);
  ...
  public function update_supplier(Request $request)
  {
    ...
    PurchaseRequisitionDetailModel::update_purchase_requisition_detail_status_id_by_ids2($action, $selected_purchase_requisition_detail_ids, 5);
    return redirect()->back();
  }
}
