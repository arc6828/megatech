...
class RequisitionModel extends Model
{
  ...
  protected $fillable = [
    'purchase_requisition_code', 'external_reference_id', 'customer_id',
    'debt_duration', 'billing_duration', 'payment_condition', 'delivery_type_id', 'tax_type_id',
    'delivery_time', 'department_id', 'purchase_status_id', 'user_id', 'zone_id', 'remark', 'vat_percent', 'total'
  ];
